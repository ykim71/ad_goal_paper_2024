...
train = pd.read_csv('data/train_2022_separate_fields.csv')#, names = ['ad_id', 'text', 'DONATE', 'CONTACT', 'PURCHASE', 'GOTV', 'EVENT', 'POLL', 'GATHERINFO', 'LEARNMORE', "PRIMARY_PERSUADE"])
test = pd.read_csv('data/test_2022_separate_fields.csv')#, names = ['ad_id', 'text', 'DONATE', 'CONTACT', 'PURCHASE', 'GOTV', 'EVENT', 'POLL', 'GATHERINFO', 'LEARNMORE', "PRIMARY_PERSUADE"])
...
text_order1 = ['ad_creative_body', 'google_asr_text', 'aws_ocr_text_img', 'aws_ocr_text_vid']
text_order2 = ['ad_creative_body', 'google_asr_text', 'aws_ocr_text_img', 'aws_ocr_text_vid', 'page_name', 'disclaimer', 'ad_creative_link_caption', 'ad_creative_link_title', 'ad_creative_link_description']
