...
rownames(results) <- c("Contact", "Donate", "Event", "Info", "Vote", "Learn", "Poll", "Persuade", "Purchase")
results <- round(results, 3)
results <- t(results)
print.xtable(xtable(results, digits = 3, label = "model_performance", caption = "Model performance, DistilBERT and Random Forest."), file = "tables/bert_vs_rf_performance.tex")
